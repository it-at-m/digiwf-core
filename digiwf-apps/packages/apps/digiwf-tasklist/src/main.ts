...
import { DwfDmsInput } from "@muenchen/digiwf-dms-input";
...
Vue.component(
  "VLdapInput",
  () => import("@/components/form/BaseLdapInput.vue")
);
Vue.component(
  "VImageOutput",
  () => import("@/components/form/ImageOutput.vue")
);
...
Vue.component(
  "VAlwDocumentInput",
  () => import("@/components/form/BaseAlwDocumentInput.vue")
);
Vue.component(
  "VDocumentInput",
  () => import("@/components/form/BaseDocumentInput.vue")
);
Vue.component(
  "VMarkdownOutput",
  () => import("@/components/form/BaseMarkdownOutput.vue")
);
...
Vue.component("DwfDmsInput", DwfDmsInput);
...
Vue.filter("highlight", function (words: any, query: any) {
  ...
  return words
    .toString()
    .replace(iQuery, function (matchedTxt: any, a: any, b: any) {
