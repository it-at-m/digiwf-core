...
export default class FetchUtils {
  ...
  public static base: string = import.meta.env.VUE_APP_API_URL ? import.meta.env.VUE_APP_API_URL + '/api/digitalwf-backend-service' : 'api/digitalwf-backend-service';
   ...
   */
  // eslint-disable-next-line
  static getPOSTConfig(body: any): RequestInit { // TODO: check if used
    return {
      method: 'POST',
  ...
  static getAxiosConfig(fetchConfig: RequestInit): Configuration {
    const init = FetchUtils.getPOSTConfig({});
