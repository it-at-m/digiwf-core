import {
  FetchUtils,
  PageServiceInstanceTO, ServiceDefinitionControllerApiFactory, ServiceDefinitionDetailTO,
  ServiceInstanceControllerApiFactory, ServiceInstanceDetailTO, StartInstanceTO,
...
export const callGetProcessInstance = (id: string): Promise<ServiceInstanceDetailTO> => {
  const cfg = ApiConfig.getAxiosConfig(FetchUtils.getGETConfig());
  return ServiceInstanceControllerApiFactory(cfg)
