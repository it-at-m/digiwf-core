...
export const ServiceInstanceFileRestControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getFileNames2: async (instanceId: string, filePath: string, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getPresignedUrlForFileDeletion2: async (instanceId: string, filename: string, filePath: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'instanceId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getPresignedUrlForFileDownload2: async (instanceId: string, fileName: string, filePath: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'instanceId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getPresignedUrlForFileUpload2: async (instanceId: string, filename: string, filePath: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'instanceId' is not null or undefined
...
export const ServiceInstanceFileRestControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getFileNames2(instanceId: string, filePath: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>> {
         ...
         * @throws {RequiredError}
         */
        async getPresignedUrlForFileDeletion2(instanceId: string, filename: string, filePath: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
         ...
         * @throws {RequiredError}
         */
        async getPresignedUrlForFileDownload2(instanceId: string, fileName: string, filePath: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
         ...
         * @throws {RequiredError}
         */
        async getPresignedUrlForFileUpload2(instanceId: string, filename: string, filePath: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
...
export class ServiceInstanceFileRestControllerApi extends BaseAPI {
     ...
     */
    public getFileNames2(instanceId: string, filePath: string, options?: any) {
     ...
     * @memberof ServiceInstanceFileRestControllerApi
     */
    public getPresignedUrlForFileDeletion2(instanceId: string, filename: string, filePath: string, options?: any) {
     ...
     * @memberof ServiceInstanceFileRestControllerApi
     */
    public getPresignedUrlForFileDownload2(instanceId: string, fileName: string, filePath: string, options?: any) {
     ...
     * @memberof ServiceInstanceFileRestControllerApi
     */
    public getPresignedUrlForFileUpload2(instanceId: string, filename: string, filePath: string, options?: any) {
