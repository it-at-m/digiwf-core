class Pagination {
  paginationElements = {
    ...
    pageSize5: () =>
      cy.get(`[data-test="pagination-page-select"] .v-list-item:nth-child(1)`),
    pageSize10: () =>
      cy.get(`[data-test="pagination-page-select"] .v-list-item:nth-child(2)`),
    pageSize20: () =>
      cy.get(`[data-test="pagination-page-select"] .v-list-item:nth-child(3)`),
  };
