...
npx cypress open # b) to open the cypress app abd run each test seperated
```
a) There will be a test summery in the end in the bash and the produced videos and test reports in the 
