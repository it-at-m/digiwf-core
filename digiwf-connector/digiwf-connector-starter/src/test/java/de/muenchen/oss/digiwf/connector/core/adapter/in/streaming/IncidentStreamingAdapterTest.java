...
class IncidentStreamingAdapterTest {
    ...
    private final IncidentStreamingAdapter incidentStreamingAdapter = new IncidentStreamingAdapter(inPort);

    @Test
    @DisplayName("should do noting if headers are empty")
    void shouldDoNothingIfHeadersAreEmpty() {
        Consumer<Message<String>> consumer = incidentStreamingAdapter.createIncident();
