...
package io.muenchendigital.digiwf.engine.basis.process.businesskeyerstellen;
 ...
 */
@Component
public class CreateBusinessKeyDelegateV02 implements JavaDelegate {

    public static final VariableFactory<String> BUSINESS_KEY_VARIABLES = stringVariable("app_business_key_variables");
