package io.muenchendigital.digiwf.engine.deployment.api.resource;

import io.muenchendigital.digiwf.engine.deployment.api.enums.DeploymentStatus;
import io.muenchendigital.digiwf.engine.deployment.api.mapper.DeploymentMapper;
import io.muenchendigital.digiwf.engine.deployment.api.transport.DeploymentDto;
import io.muenchendigital.digiwf.engine.deployment.api.transport.DeploymentStatusDto;
import io.muenchendigital.digiwf.engine.deployment.domain.model.DeploymentStatusModel;
import io.muenchendigital.digiwf.engine.deployment.domain.service.ModelDeploymentService;
