...
package io.muenchendigital.digiwf.service.config.domain.service;

import io.muenchendigital.digiwf.service.config.domain.mapper.ProcessConfigMapper;
import io.muenchendigital.digiwf.service.config.domain.model.ProcessConfig;
import io.muenchendigital.digiwf.service.config.infrastructure.repository.ProcessConfigRepository;
