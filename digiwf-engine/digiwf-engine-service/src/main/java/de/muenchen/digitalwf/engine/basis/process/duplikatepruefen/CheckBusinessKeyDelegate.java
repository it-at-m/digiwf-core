...
package de.muenchen.digitalwf.engine.basis.process.duplikatepruefen;
...
public class CheckBusinessKeyDelegate implements JavaDelegate {
    ...
    public static final VariableFactory<String> EXISTING_PROCESS_INSTANCES = stringVariable("digitalwf_existing_process_instances");
    public static final VariableFactory<Boolean> PROCESSES_EXIST = booleanVariable("digitalwf_processes_exist");
    public static final VariableFactory<String> PROCESS_DEFINITION_KEY = stringVariable("digitalwf_process_definition_key");
    public static final VariableFactory<String> PROCESS_INSTANCE_ID = stringVariable("digitalwf_process_instance_id");
    public static final VariableFactory<String> PROCESS_BUSINESS_KEY = stringVariable("digitalwf_process_business_key");
