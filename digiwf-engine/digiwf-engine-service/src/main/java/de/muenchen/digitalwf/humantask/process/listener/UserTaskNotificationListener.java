...
public class UserTaskNotificationListener {
    ...
    public void delegateTask(final DelegateTask delegateTask) throws Exception {
        if (delegateTask.getEventName().equals("create")) {
            ...
            val notifyAssigneeV02 = APP_NOTIFICATION_SEND_ASSIGNEE.from(delegateTask).getOptional();
            ...
            val notifyCandidateUsersV02 = APP_NOTIFICATION_SEND_CANDIDATE_USERS.from(delegateTask).getOptional();
            ...
            val notifyCandidateGroupsV02 = APP_NOTIFICATION_SEND_CANDIDATE_GROUPS.from(delegateTask).getOptional();
