package de.muenchen.digitalwf.engine.deployment.api.resource;

import de.muenchen.digitalwf.engine.deployment.api.enums.DeploymentStatus;
import de.muenchen.digitalwf.engine.deployment.api.mapper.DeploymentMapper;
import de.muenchen.digitalwf.engine.deployment.api.transport.DeploymentDto;
import de.muenchen.digitalwf.engine.deployment.api.transport.DeploymentStatusDto;
import de.muenchen.digitalwf.engine.deployment.domain.model.DeploymentStatusModel;
import de.muenchen.digitalwf.engine.deployment.domain.service.ModelDeploymentService;
