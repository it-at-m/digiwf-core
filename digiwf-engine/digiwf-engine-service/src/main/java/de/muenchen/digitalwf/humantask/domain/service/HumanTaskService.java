...
import de.muenchen.digitalwf.humantask.domain.mapper.HumanTaskMapper;
...
import de.muenchen.digitalwf.shared.exception.ObjectNotFoundException;
...
import static de.muenchen.digitalwf.humantask.process.ProcessTaskConstants.TASK_STATUS_DOKUMENT;
...
public class HumanTaskService {
    ...
    public HumanTaskDetail getDetail(final String taskId, final String userId, final List<String> groups) {
        ...
        if (form.isEmpty()) {
            ...
            detail.setStatusDocument(this.humanTaskDataService.getVariable(task.getId(), TASK_STATUS_DOKUMENT).map(Boolean::valueOf).orElse(false));
        }
        return detail;
    }
