...
package de.muenchen.digitalwf.legacy.file.domain.service;

import de.muenchen.digitalwf.legacy.file.domain.mapper.FileMapper;
import de.muenchen.digitalwf.legacy.file.domain.model.File;
import de.muenchen.digitalwf.legacy.file.domain.model.NewFile;
import de.muenchen.digitalwf.legacy.file.infrastructure.repository.FileRepository;
