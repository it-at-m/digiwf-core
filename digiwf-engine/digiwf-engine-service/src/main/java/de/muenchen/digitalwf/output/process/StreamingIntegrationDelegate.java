package de.muenchen.digitalwf.output.process;
...
public class StreamingIntegrationDelegate extends AbstractStreamingIntegrationDelegate implements JavaDelegate {
    ...
    public StreamingIntegrationDelegate(final EngineDataMapper engineDataMapper, final Sinks.Many<Message<Map<String, Object>>> dynamicSink) {
