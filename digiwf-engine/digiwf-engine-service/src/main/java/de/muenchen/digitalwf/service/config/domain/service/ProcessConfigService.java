...
package de.muenchen.digitalwf.service.config.domain.service;

import de.muenchen.digitalwf.service.config.domain.mapper.ProcessConfigMapper;
import de.muenchen.digitalwf.service.config.domain.model.ProcessConfig;
import de.muenchen.digitalwf.service.config.infrastructure.repository.ProcessConfigRepository;
