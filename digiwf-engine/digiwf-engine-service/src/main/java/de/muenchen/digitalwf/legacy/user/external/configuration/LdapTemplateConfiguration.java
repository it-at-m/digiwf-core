 ...
 */
package de.muenchen.digitalwf.legacy.user.external.configuration;

import de.muenchen.digitalwf.legacy.user.external.client.query.LdapFilterFactory;
import de.muenchen.digitalwf.legacy.user.external.client.query.LdapQueryFactory;
import de.muenchen.digitalwf.legacy.user.external.client.LhmLdapClient;
