...
package de.muenchen.digitalwf.legacy.dms.muc.external.client;

import com.fabasoft.schemas.websvc.lhmbai_15_1700_giwsd.*;
import de.muenchen.digitalwf.legacy.dms.muc.domain.model.*;
import de.muenchen.digitalwf.legacy.dms.muc.external.mapper.DMSSearchResultMapper;
import de.muenchen.digitalwf.legacy.dms.muc.external.transport.DMSException;
import de.muenchen.digitalwf.legacy.dms.muc.external.transport.DMSObjectClass;
import de.muenchen.digitalwf.legacy.dms.muc.external.transport.DMSSearchResult;
import de.muenchen.digitalwf.legacy.dms.muc.external.transport.DMSStatusCode;
import de.muenchen.digitalwf.legacy.dms.muc.properties.DmsProperties;
