 ...
 */
package de.muenchen.digitalwf.legacy.user.external.client;
...
import de.muenchen.digitalwf.legacy.user.external.client.query.LdapQueryFactory;
import lombok.val;
...
import de.muenchen.digitalwf.legacy.user.external.mapper.LdapAttributeConstants;
import de.muenchen.digitalwf.legacy.user.external.mapper.UserAttributesMapper;
import de.muenchen.digitalwf.legacy.user.infrastructure.UserRepository;
...
public class LhmLdapClient extends LdapTemplate implements UserRepository {
    ...
    public LhmLdapClient(final ContextSource contextSource, final LdapQueryFactory ldapQueryFactory) {
        super(contextSource);
