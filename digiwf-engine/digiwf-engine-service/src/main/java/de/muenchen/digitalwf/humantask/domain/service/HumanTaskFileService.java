...
import de.muenchen.digitalwf.humantask.process.ProcessTaskConstants;
...
import de.muenchen.digitalwf.shared.exception.NoFileContextException;
import de.muenchen.digitalwf.shared.file.AbstractFileService;
import de.muenchen.digitalwf.shared.file.presignedUrlAdapters.PresignedUrlAction;
import de.muenchen.digitalwf.shared.file.presignedUrlAdapters.PresignedUrlAdapter;
...
public class HumanTaskFileService extends AbstractFileService {
    ...
    protected Optional<String> getDocumentStorageUrl(final String taskId) {
        return this.humanTaskDataService.getVariable(taskId, PROCESS_S3_SYNC_CONFIG);
    }
