...
package de.muenchen.digitalwf.legacy.user.api.resource;

import de.muenchen.digitalwf.legacy.user.api.mapper.UserTOMapper;
import de.muenchen.digitalwf.legacy.user.api.transport.SearchUserTO;
