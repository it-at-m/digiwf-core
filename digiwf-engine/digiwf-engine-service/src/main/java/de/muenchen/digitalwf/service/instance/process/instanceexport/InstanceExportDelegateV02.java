...
package de.muenchen.digitalwf.service.instance.process.instanceexport;

import de.muenchen.digitalwf.engine.basis.domain.CsvService;
import de.muenchen.digitalwf.service.instance.domain.service.ServiceInstanceService;
...
public class InstanceExportDelegateV02 implements JavaDelegate {

    public static final VariableFactory<String> PROCESS_KEY = stringVariable("app_process_key");
    public static final VariableFactory<String> VARIABLES = stringVariable("app_variables");
    public static final VariableFactory<String> STATUS_KEY = stringVariable("app_status_key");

    public static final VariableFactory<byte[]> PROCESS_EXPORT = customVariable("app_instance_export", byte[].class);
