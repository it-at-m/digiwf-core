package de.muenchen.digitalwf.jsonschema.deployment.api.streaming;
...
import de.muenchen.digitalwf.jsonschema.deployment.domain.service.SchemaDeploymentService;
