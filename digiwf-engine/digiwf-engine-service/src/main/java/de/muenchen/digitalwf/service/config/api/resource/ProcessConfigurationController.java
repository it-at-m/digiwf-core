...
package de.muenchen.digitalwf.service.config.api.resource;

import de.muenchen.digitalwf.service.config.api.mapper.ProcessConfigApiMapper;
...
public class ProcessConfigurationController {
     ...
     */
    @PostMapping
    @PreAuthorize("hasAuthority(T(de.muenchen.digitalwf.shared.security.AuthoritiesEnum).BACKEND_DEPLOY_RESOURCE.name())")
