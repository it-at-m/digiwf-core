 ...
 */
package de.muenchen.digitalwf.legacy.user.external.client.query;

import de.muenchen.digitalwf.legacy.user.external.configuration.ServiceAuthLdapProperties;
