...
import de.muenchen.oss.digiwf.engine.basis.process.businesskeyerstellen.CreateBusinessKeyDelegateV02;
import de.muenchen.oss.digiwf.engine.basis.process.duplikatepruefen.CheckBusinessKeyDelegateV02;
...
public class DuplikatePruefenTemplateV02Test {
  ...
  public static final String TEMPLATE_KEY = "FeatureDuplikatePruefenV02";
  ...
  public void defaultScenario() throws Exception {
    ...
    Mocks.register("createBusinessKeyDelegateV02", new CreateBusinessKeyDelegateV02());

    Mocks.register("checkBusinessKeyDelegateV02", new CheckBusinessKeyDelegateV02(this.processEngineExtension.getRuntimeService(), this.processEngineExtension.getHistoryService()));
