...
import io.muenchendigital.digiwf.engine.basis.process.businesskeyerstellen.CreateBusinessKeyDelegateV02;
import io.muenchendigital.digiwf.engine.basis.process.duplikatepruefen.CheckBusinessKeyDelegateV02;
...
public class DuplikatePruefenTemplateV02Test {
    ...
    public void defaultScenario() throws Exception {
        ...
        Mocks.register("checkBusinessKeyDelegateV02", new CheckBusinessKeyDelegateV02(this.rule.getRuntimeService(), this.rule.getHistoryService()));
