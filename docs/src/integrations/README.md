...
Prozessbeispiele und Formulare für die Verwendung der Integration können [hier](modeling/templates/examples) heruntergeladen werden.
Element-Templates für eigene Bausteine können [hier](/modeling/templates/element-templates) heruntergeladen werden.
