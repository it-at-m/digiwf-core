...
public class MessageProcessor {
    ...
    public Consumer<Message<ExampleDto>> exampleIntegration() {
        return message -> {
            ...
            // correlate message
            processApi.correlateMessage(processInstanceId, integrationName, new HashMap<String, Object>());
        };
    }   
}
```
    ...
    public Consumer<Message<ExampleDto>> exampleIntegration() {
        return message -> {
            try {
                ...
                // correlate message
                this.processApi.correlateMessage(processInstanceId, integrationName, new HashMap<String, Object>());
