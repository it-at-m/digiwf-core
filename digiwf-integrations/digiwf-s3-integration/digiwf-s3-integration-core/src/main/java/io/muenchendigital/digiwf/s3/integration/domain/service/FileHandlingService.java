...
public class FileHandlingService {
   ...
   * @throws S3AccessException      on S3 access errors.
   * @throws FileExistenceException if file doesn't exist.
   */
  public List<PresignedUrl> getPresignedUrls(final List<String> paths, final Method action, final int expiresInMinutes) throws S3AccessException, FileExistenceException {
   ...
   * @throws FileExistenceException if file doesn't exist.
   */
  public List<PresignedUrl> getPresignedUrls(final List<String> paths, final Method action, final int expiresInMinutes, LocalDate endOfLife) throws S3AccessException, FileExistenceException {
   ...
   * @throws FileExistenceException if file doesn't exist.
   */
  public List<PresignedUrl> getPresignedUrls(final String path, final Method action, final int expiresInMinutes, final LocalDate endOfLife) throws S3AccessException, FileExistenceException {
   ...
   */
  public PresignedUrl getFile(final String pathToFile, final int expiresInMinutes) throws FileExistenceException, S3AccessException {
   ...
   */
  @Transactional
  public PresignedUrl saveFile(final FileData fileData) throws S3AccessException, FileExistenceException {
   ...
   */
  @Transactional
  public PresignedUrl deleteFile(final String pathToFile, final int expiresInMinutes) throws FileExistenceException, S3AccessException {
    if (!this.fileExists(pathToFile)) {
      final String message = String.format("The file %s does not exists.", pathToFile);
      log.error(message);
      throw new FileExistenceException(message);
