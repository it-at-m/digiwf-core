...
public class S3Repository {
     ...
     */
    public Set<String> getFilePathsFromFolder(final String folder) throws S3AccessException {
        try {
     ...
     */
    public String getPresignedUrl(final String pathToFile, final Method action, final int expiresInMinutes) throws S3AccessException {
        try {
