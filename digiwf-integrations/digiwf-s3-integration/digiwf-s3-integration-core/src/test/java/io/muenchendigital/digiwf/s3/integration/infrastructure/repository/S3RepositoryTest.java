...
public class S3RepositoryTest {
    ...
    @BeforeEach
    public void beforeEach() throws S3AccessException {
        this.s3Repository = new S3Repository("test-bucket", this.s3Url, this.client, false, Optional.empty());
    }

    @Test
    public void testGetPresignedUrlWithoutProxy() throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException, S3AccessException {
    ...
    @Test
    public void testGetPresignedUrlWithProxy() throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException, S3AccessException {
