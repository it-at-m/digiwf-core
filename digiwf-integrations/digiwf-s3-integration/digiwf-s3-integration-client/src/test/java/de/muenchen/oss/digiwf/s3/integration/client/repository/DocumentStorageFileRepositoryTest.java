...
class DocumentStorageFileRepositoryTest {
    ...
    public void beforeEach() {
        this.documentStorageFileRepository = new DocumentStorageFileRepository(this.presignedUrlRepository, this.s3FileTransferRepository, this.apiClientFactory, this.s3DomainService);
        Mockito.reset(this.presignedUrlRepository, this.s3FileTransferRepository, this.fileApi, this.apiClientFactory, this.s3DomainService);
    }
    ...
    void getFile() throws DocumentStorageException, DocumentStorageClientErrorException, DocumentStorageServerErrorException, PropertyNotSetException {
        ...
        Mockito.when(this.s3DomainService.getDefaultDocumentStorageUrl()).thenReturn("url");
