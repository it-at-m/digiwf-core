package de.muenchen.oss.digiwf.okewo.integration.streaming;
...
import de.muenchen.oss.digiwf.okewo.integration.dto.request.OkEwoEventDto;
import de.muenchen.oss.digiwf.okewo.integration.dto.request.OrdnungsmerkmalDto;
import de.muenchen.oss.digiwf.okewo.integration.dto.request.SearchPersonErweitertRequestDto;
import de.muenchen.oss.digiwf.okewo.integration.dto.request.SearchPersonRequestDto;
import de.muenchen.oss.digiwf.okewo.integration.dto.response.OkEwoErrorDto;
...
public class OkEwoStreamingEventListener {
  ...
  public Consumer<Message<OkEwoEventDto>> getPerson() {
    return message -> {
      ...
      integrationOutPort.correlateProcessMessage(
          message.getHeaders(),
