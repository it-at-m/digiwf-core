...
import de.muenchen.oss.digiwf.dms.integration.adapter.out.ProcessAdapter;
...
class SendMailUseCaseTest {
    ...
    void setUp() {
        ...
        when(this.loadMailAttachmentPort.loadAttachment(any())).thenReturn(new File("Testanhang", new ByteArrayDataSource(anhangByt, "AttName")));
    }
    ...
    void sendMail() throws MessagingException {
        ...
        sendMailUseCase.createVorgang("processInstanceIde", "messageName", this.mail);
    ...
    void sendMailWithAttachments() throws MessagingException {
        ...
        sendMailUseCase.createVorgang("processInstanceIde", "messageName", mailWithAttachments);
        ...
        final File result = this.loadMailAttachmentPort.loadAttachment(any());
