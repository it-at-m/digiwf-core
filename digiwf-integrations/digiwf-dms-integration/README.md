...
3. Run the Email Integration ([digiwf-email-integration-service](digiwf-dms-integration-service)
...
2. Test the functionality with the
   process [example-email-V02](../../digiwf-engine/digiwf-engine-service/src/main/resources/prozesse/example/email-example-V02)
