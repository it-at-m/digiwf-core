...
class TaskFileConfigTest {
    ...
    void checkReadAccessThrowsException() {
        Exception exception = assertThrows(IllegalResourceAccessException.class, () -> { config.checkReadAccess("f");});
    ...
    void checkWriteAccessInReadOnlyListThrowsException() {
        Exception exception = assertThrows(IllegalResourceAccessException.class, () -> { config.checkWriteAccess("d");});
    ...
    void checkWriteAccessThrowsException() {
        Exception exception = assertThrows(IllegalResourceAccessException.class, () -> { config.checkWriteAccess("f");});
