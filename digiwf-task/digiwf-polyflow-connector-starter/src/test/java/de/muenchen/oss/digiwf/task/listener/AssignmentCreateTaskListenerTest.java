...
class AssignmentCreateTaskListenerTest {
  ...
  public void shadows_assignee_local() {
    ...
    assertThat(delegateTask.getVariablesLocal()).containsEntry(TaskVariables.TASK_CANDIDATE_USERS.getName(), Lists.newArrayList("candidateUser1", "candidateUser2"));
    assertThat(delegateTask.getVariablesLocal()).containsEntry(TaskVariables.TASK_CANDIDATE_GROUPS.getName(), Lists.newArrayList("candidategroup1", "candidategroup2"));
  ...
  public void shadows_assignee_global() {
    ...
    assertThat(delegateTask.getVariables()).containsEntry(TaskVariables.TASK_CANDIDATE_USERS.getName(), Lists.newArrayList("candidateUser1", "candidateUser2"));
    assertThat(delegateTask.getVariables()).containsEntry(TaskVariables.TASK_CANDIDATE_GROUPS.getName(), Lists.newArrayList("candidategroup1", "candidategroup2"));
