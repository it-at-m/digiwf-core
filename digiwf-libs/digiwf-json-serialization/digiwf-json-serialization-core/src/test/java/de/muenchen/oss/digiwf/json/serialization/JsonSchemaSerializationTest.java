...
public class JsonSchemaSerializationTest {
    ...
    public void serialize_and_filter_data_with_simple_schema() throws URISyntaxException, IOException {
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/serialization/simpleSchema.json");
    ...
    public void serialize_and_filter_data_with_complex_allOf_schema() throws URISyntaxException, IOException {
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/serialization/schema.json");
    ...
    public void serialize_allOf_object_schema() throws URISyntaxException, IOException {
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/serialization/objectSchema.json");
    ...
    public void serialize_data_with_custom_type_schema() throws URISyntaxException, IOException {
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/serialization/customTypesSchema.json");
    ...
    public void serialize_complex_object_structure() throws URISyntaxException, IOException {
        ...
        Assertions.assertThat(JsonSchemaTestUtils.areEqual(erg, serializedData)).isEqualTo(true);
    }
    ...
    public void serialize_conditional_subschema() throws URISyntaxException, IOException {
        ...
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/validation/conditionalSubSchema.json");
    ...
    public void initialize_simple_schema_with_readonly_false() throws URISyntaxException, IOException {
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/serialization/simpleSchemaWithReadonlyFalse.json");
