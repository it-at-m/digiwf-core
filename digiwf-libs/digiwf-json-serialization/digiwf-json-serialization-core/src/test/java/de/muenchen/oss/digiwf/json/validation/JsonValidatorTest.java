...
public class JsonValidatorTest {
    ...
    public void simple_schema_is_valid() throws URISyntaxException, IOException {
        ...
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/validation/simpleSchema.json");
    ...
    public void basic_properties_are_valid() throws URISyntaxException, IOException {
        ...
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/validation/schema.json");
    ...
    public void object_schema_is_valid() throws URISyntaxException, IOException {
        ...
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/validation/objectSchema.json");
        this.validationService.validate(new JSONObject(rawSchema).toMap(), acutalData);
    }
    ...
    public void nested_allOf_schema_is_valid() throws URISyntaxException, IOException {
        ...
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/validation/complexObjectSchema.json");
        this.validationService.validate(new JSONObject(rawSchema).toMap(), acutalData);
    }
    ...
    public void textarea_with_maxlength_is_valid() throws URISyntaxException, IOException {
        ...
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/validation/textAreaSchema.json");

        this.validationService.validate(JsonSchemaTestUtils.getSchemaMap(rawSchema), acutalData);
    }

    @Test
    public void objekt_schema_without_additionalPropperties_fails() throws IOException, URISyntaxException {

        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/validation/complexObjectSchemaAdditionalPropertiesFalse.json");
        final Map<String, Object> acutalData = Map.of(
                "textarea", "12",
    ...
    public void select_schema_with_wrong_data_fails() throws URISyntaxException, IOException {
        ...
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/validation/complexSchema.json");
        final DigiWFValidationException exception = assertThrows(DigiWFValidationException.class, () -> {
            this.validationService.validate(new JSONObject(rawSchema).toMap(), acutalData);
        });
    ...
    public void number_as_string_is_valid() throws URISyntaxException, IOException {
        ...
        final String rawSchema = JsonSchemaTestUtils.getSchemaString("/schema/validation/simpleNumberSchema.json");
        this.validationService.validate(new JSONObject(rawSchema).toMap(), data);
    }
