...
public class JsonValidatorTest {
    ...
    @Test
    public void empty_select_as_string_stephan() throws IOException, URISyntaxException {
        final Map<String, Object> data = Map.of(
                "66e6c72f-2fbd-4ed4-9dd5-d27f567f88db", "",
                "e42d4942-057d-46bc-b0cc-79150c31c54d", "1",
                "37a17cf4-1028-4b13-a131-6e0ebc7bbfbf", ""
        );

        final String rawSchema = getSchemaString("/schema/validation/emptyString.json");
        this.validationService.validate(new JSONObject(rawSchema).toMap(), data);
    }
}
